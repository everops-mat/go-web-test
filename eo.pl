...
We didn't think it was DNS, but it was DNS!
";

srand(time);

my @excuse = split("\n",$excuses);
my $number = scalar(@excuse);
...
<head>
    ...
    <link rel=\"stylesheet\" href=\"https://www.everops.com/wp-includes/css/dist/block-library/style.min.css?ver=6.7.1\">
...
<body>
    <div class="container">
        ...
        <p class="excuse">$thisexcuse</p>
        <hr>
        <p><small>Generated dynamically. Reload for a new oppritunity.</small></p>
    </div>
</body>
</html>
HTML
